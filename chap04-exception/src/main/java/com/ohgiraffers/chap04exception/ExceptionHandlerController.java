...
public class ExceptionHandlerController {
    ...
    public String nullPointExceptionHandler(NullPointerException e) {
        ...
        return "error/nullPointer"; // 뷰 이름
    }

    @GetMapping("controller-user")
    public String uesrException() throws MemberRegistException {
        boolean check = true;
        if (check) {
    ...
    public String uesrExceptionHandler(Model model, MemberRegistException e){
        System.out.println("controller 레벨의 exception 처리");
